...
@Composable
internal fun EmailSentDialog(onClose: () -> Unit, onOpenEmailBox: () -> Unit) {
    AlertDialog(
        ...
        confirmButton = {
            Button(onClick = onOpenEmailBox, modifier = Modifier.fillMaxWidth()) {
...
private fun EmailSentDialogPreview() {
    EmailSentDialog(onClose = {}, onOpenEmailBox = {})
}